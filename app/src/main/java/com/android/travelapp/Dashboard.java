...
public class Dashboard extends AppCompatActivity {
    ...
    private void callCenter() {
        alertDialog = new AlertDialog.Builder(Dashboard.this)
                ...
                .setNeutralButton("Call", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialogInterface, int i) {
                        Uri uri = Uri.parse("0895377164901");
    ...
    private void emailCenter(){
        alertDialog = new AlertDialog.Builder(Dashboard.this)
                ...
                .setTitle("Email")
                .setMessage("\nrizkiiki254@gmail.com")
                .setNeutralButton("Go to Email", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialogInterface, int i) {
                        Intent intent = new Intent(Intent.ACTION_SEND );
                        intent.putExtra(Intent.EXTRA_EMAIL, new String[]{"rizkiiki254@gmail.com"});
                        intent.putExtra(Intent.EXTRA_SUBJECT , "Komplain dong");
    ...
    private void getLoc(){
        alertDialog = new AlertDialog.Builder(Dashboard.this)
                .setIcon(android.R.drawable.ic_dialog_info)
                .setTitle("Location")
                .setMessage("\nKlipang Green, Jl, Klipang, Sendangmulyo, Kec. Tembalang, Kota Semarang, Jawa Tengah 50272")
                .setNeutralButton("Go to Location", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialogInterface, int i) {
                        Uri uri2 = Uri.parse("geo:0,0?q="+"Klipang Green, Jl. Klipang, Sendangmulyo, Kec. Tembalang, Kota Semarang, Jawa Tengah 50272");
